...
public abstract class Hilt_FragmentEnter<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentEnter_GeneratedInjector) this.generatedComponent()).injectFragmentEnter(UnsafeCasts.<FragmentEnter>unsafeCast(this));
    }
  }
