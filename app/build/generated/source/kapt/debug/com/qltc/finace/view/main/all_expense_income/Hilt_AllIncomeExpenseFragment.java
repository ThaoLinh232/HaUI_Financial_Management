...
public abstract class Hilt_AllIncomeExpenseFragment<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AllIncomeExpenseFragment_GeneratedInjector) this.generatedComponent()).injectAllIncomeExpenseFragment(UnsafeCasts.<AllIncomeExpenseFragment>unsafeCast(this));
    }
  }
