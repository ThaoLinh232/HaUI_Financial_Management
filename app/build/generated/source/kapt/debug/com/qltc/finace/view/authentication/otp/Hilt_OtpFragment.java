...
public abstract class Hilt_OtpFragment<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OtpFragment_GeneratedInjector) this.generatedComponent()).injectOtpFragment(UnsafeCasts.<OtpFragment>unsafeCast(this));
    }
  }
