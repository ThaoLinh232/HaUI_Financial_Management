...
public abstract class Hilt_FragmentChangePassword<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentChangePassword_GeneratedInjector) this.generatedComponent()).injectFragmentChangePassword(UnsafeCasts.<FragmentChangePassword>unsafeCast(this));
    }
  }
