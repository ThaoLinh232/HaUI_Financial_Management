...
public abstract class Hilt_FragmentCategoryDetail<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentCategoryDetail_GeneratedInjector) this.generatedComponent()).injectFragmentCategoryDetail(UnsafeCasts.<FragmentCategoryDetail>unsafeCast(this));
    }
  }
