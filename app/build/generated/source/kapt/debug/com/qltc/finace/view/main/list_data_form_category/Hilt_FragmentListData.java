...
public abstract class Hilt_FragmentListData<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentListData_GeneratedInjector) this.generatedComponent()).injectFragmentListData(UnsafeCasts.<FragmentListData>unsafeCast(this));
    }
  }
