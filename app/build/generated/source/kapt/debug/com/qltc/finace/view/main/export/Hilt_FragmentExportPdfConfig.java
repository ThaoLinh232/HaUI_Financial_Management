...
public abstract class Hilt_FragmentExportPdfConfig<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentExportPdfConfig_GeneratedInjector) this.generatedComponent()).injectFragmentExportPdfConfig(UnsafeCasts.<FragmentExportPdfConfig>unsafeCast(this));
    }
  }
