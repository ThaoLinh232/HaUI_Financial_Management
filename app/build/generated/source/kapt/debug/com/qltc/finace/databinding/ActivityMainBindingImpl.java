...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.nav_home_container, 2);
        sViewsWithIds.put(R.id.navigation_view_drawer, 3);
    }
    // views
    // variables
    // values
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.qltc.finace.view.activity.home.HomeActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.qltc.finace.view.activity.home.HomeActivityViewModel ViewModel) {
