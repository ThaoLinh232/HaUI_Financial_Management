...
public abstract class Hilt_FragmentForgotPassword<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentForgotPassword_GeneratedInjector) this.generatedComponent()).injectFragmentForgotPassword(UnsafeCasts.<FragmentForgotPassword>unsafeCast(this));
    }
  }
