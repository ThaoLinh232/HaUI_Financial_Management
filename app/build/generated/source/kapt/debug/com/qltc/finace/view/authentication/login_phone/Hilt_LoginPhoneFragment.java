...
public abstract class Hilt_LoginPhoneFragment<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginPhoneFragment_GeneratedInjector) this.generatedComponent()).injectLoginPhoneFragment(UnsafeCasts.<LoginPhoneFragment>unsafeCast(this));
    }
  }
