...
public abstract class Hilt_FragmentReportInCome<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentReportInCome_GeneratedInjector) this.generatedComponent()).injectFragmentReportInCome(UnsafeCasts.<FragmentReportInCome>unsafeCast(this));
    }
  }
