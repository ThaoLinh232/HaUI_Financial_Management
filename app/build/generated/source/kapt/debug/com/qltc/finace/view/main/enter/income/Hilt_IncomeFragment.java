...
public abstract class Hilt_IncomeFragment<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IncomeFragment_GeneratedInjector) this.generatedComponent()).injectIncomeFragment(UnsafeCasts.<IncomeFragment>unsafeCast(this));
    }
  }
