...
public abstract class Hilt_CalendarFragment<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CalendarFragment_GeneratedInjector) this.generatedComponent()).injectCalendarFragment(UnsafeCasts.<CalendarFragment>unsafeCast(this));
    }
  }
