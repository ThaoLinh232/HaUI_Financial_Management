...
public abstract class Hilt_FragmentEditExpenseIncome<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentEditExpenseIncome_GeneratedInjector) this.generatedComponent()).injectFragmentEditExpenseIncome(UnsafeCasts.<FragmentEditExpenseIncome>unsafeCast(this));
    }
  }
