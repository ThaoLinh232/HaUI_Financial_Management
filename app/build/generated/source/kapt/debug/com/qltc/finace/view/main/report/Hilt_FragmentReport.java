...
public abstract class Hilt_FragmentReport<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentReport_GeneratedInjector) this.generatedComponent()).injectFragmentReport(UnsafeCasts.<FragmentReport>unsafeCast(this));
    }
  }
