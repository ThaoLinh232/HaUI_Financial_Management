...
public abstract class Hilt_FragmentExpense<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentExpense_GeneratedInjector) this.generatedComponent()).injectFragmentExpense(UnsafeCasts.<FragmentExpense>unsafeCast(this));
    }
  }
