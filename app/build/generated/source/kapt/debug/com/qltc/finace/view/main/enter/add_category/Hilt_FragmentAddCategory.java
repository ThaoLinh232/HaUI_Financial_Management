...
public abstract class Hilt_FragmentAddCategory<ViewBinding extends ViewDataBinding, viewModel extends BaseViewModel> extends BaseFragment<ViewBinding, viewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentAddCategory_GeneratedInjector) this.generatedComponent()).injectFragmentAddCategory(UnsafeCasts.<FragmentAddCategory>unsafeCast(this));
    }
  }
