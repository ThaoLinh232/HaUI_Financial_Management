...
public final class CategoryIncomeDetail {
    ...
    public CategoryIncomeDetail(@org.jetbrains.annotations.Nullable()
    com.qltc.finace.data.entity.Category category, long totalAmount, @org.jetbrains.annotations.Nullable()
    java.util.List<com.qltc.finace.data.entity.Income> listIncome) {
        super();
    }
    ...
    public final void setListIncome(@org.jetbrains.annotations.Nullable()
    java.util.List<com.qltc.finace.data.entity.Income> p0) {
    }
    
    public CategoryIncomeDetail() {
        super();
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.util.List<com.qltc.finace.data.entity.Income> component3() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final com.qltc.finace.data.entity.CategoryIncomeDetail copy(@org.jetbrains.annotations.Nullable()
    com.qltc.finace.data.entity.Category category, long totalAmount, @org.jetbrains.annotations.Nullable()
    java.util.List<com.qltc.finace.data.entity.Income> listIncome) {
        return null;
    }
